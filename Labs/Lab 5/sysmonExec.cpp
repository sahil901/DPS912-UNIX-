...
// error in the file you had provided so i made it const char 
const char* intf[] = { "lo", "ens33" };
...
int systemMonitor()//run by the parent process
{
    ...
    for (int i = 0; i < NUM; i++)
    {
        ...
        {
            cout << "SIGUSR1 has sent start signals to the childen: " << childPid[i] << endl;
        }
        ...
        {
            cout << "There is no child with the following PID: " << childPid[i] << endl;
        }
    };
    ...
    for (int i = 0; i < NUM; i++)
    {
        ...
        {
            cout << "SIGUSR1 has sent stop signals to the childen: " << childPid[i] << endl;
        }
